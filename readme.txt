...
= 1.7 =
This upgrade is tested against WP 4.5.

= 1.5 =
This upgrade includes resources that were missing in the previous release.

= 1.4 =
This upgrade includes a fix for the Navbar not showing under some installations.
